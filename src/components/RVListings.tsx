...
import { Users, Bed, Utensils } from "lucide-react";
...
const RVListings = () => {
  const rvs = [
    ...
    },
    {
      ...
      sleeps: 10,
      description: "Our trailers are light and easy to handle for most SUV/Trucks with a V8. They sleep up to 10 people, great for families! Many basics are provided, including utensils, cookware, games, towels, bedding, and a Blackstone Flat top grill provided for outdoor cooking convenience. Trailer hitch and sway bars are also provided.",
    ...
    <section id="rentals" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {rvs.map((rv, index) => (
            <Card key={index} className="overflow-hidden border-border hover:shadow-xl transition-all duration-300">
              <div className="aspect-video overflow-hidden">
                <img 
                  src={rv.image} 
                  alt={`${rv.name} interior`}
